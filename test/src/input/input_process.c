...
//3. 문법검사
//4. herdoc처리
//5. GRAMMAR_OK일때 확장, 분리 및 quote제거
int	input_process(t_prompt *prompt)
{
	...
	//print_tokens(prompt->token_lst, "check");
